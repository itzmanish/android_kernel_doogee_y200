...
static void sensor_init(void)
{
    ...
    */
    ...
    write_cmos_sensor(0x3034, 26);
    write_cmos_sensor(0x3035, 33);
    write_cmos_sensor(0x3036, 105);
    write_cmos_sensor(0x3037, 3);
    write_cmos_sensor(0x3038, 0);
    write_cmos_sensor(0x3039, 0);
    write_cmos_sensor(0x303A, 0);
    write_cmos_sensor(0x303B, 25);
    write_cmos_sensor(0x303C, 17);
    write_cmos_sensor(0x303D, 48);
    write_cmos_sensor(0x3105, 17);
    write_cmos_sensor(0x3106, 5);
    write_cmos_sensor(0x3304, 40);
    write_cmos_sensor(0x3305, 65);
    write_cmos_sensor(0x3306, 48);
    write_cmos_sensor(0x3308, 0);
    write_cmos_sensor(0x3309, -56);
    write_cmos_sensor(0x330A, 1);
    write_cmos_sensor(0x330B, -112);
    write_cmos_sensor(0x330C, 2);
    write_cmos_sensor(0x330D, 88);
    write_cmos_sensor(0x330E, 3);
    write_cmos_sensor(0x330F, 32);
    write_cmos_sensor(0x3300, 0);
    write_cmos_sensor(0x3503, 7);
    write_cmos_sensor(0x350A, 0);
    write_cmos_sensor(0x350B, 64);
    write_cmos_sensor(0x3601, 51);
    write_cmos_sensor(0x3602, 0);
    write_cmos_sensor(0x3611, 14);
    write_cmos_sensor(0x3612, 43);
    write_cmos_sensor(0x3614, 80);
    write_cmos_sensor(0x3620, 51);
    write_cmos_sensor(0x3622, 0);
    write_cmos_sensor(0x3630, -83);
    write_cmos_sensor(0x3631, 0);
    write_cmos_sensor(0x3632, -108);
    write_cmos_sensor(0x3633, 23);
    write_cmos_sensor(0x3634, 20);
    write_cmos_sensor(0x3704, -64);
    write_cmos_sensor(0x3705, 42);
    write_cmos_sensor(0x3708, 102);
    write_cmos_sensor(0x3709, 82);
    write_cmos_sensor(0x370B, 35);
    write_cmos_sensor(0x370C, -61);
    write_cmos_sensor(0x370D, 0);
    write_cmos_sensor(0x370E, 0);
    write_cmos_sensor(0x371C, 7);
    write_cmos_sensor(0x3739, -46);
    write_cmos_sensor(0x373C, 0);
    write_cmos_sensor(0x3800, 0);
    write_cmos_sensor(0x3801, 0);
    write_cmos_sensor(0x3802, 0);
    write_cmos_sensor(0x3803, 0);
    write_cmos_sensor(0x3804, 10);
    write_cmos_sensor(0x3805, 63);
    write_cmos_sensor(0x3806, 7);
    write_cmos_sensor(0x3807, -93);
    write_cmos_sensor(0x3808, 5);
    write_cmos_sensor(0x3809, 16);
    write_cmos_sensor(0x380A, 3);
    write_cmos_sensor(0x380B, -52);
    write_cmos_sensor(0x380C, 11);
    write_cmos_sensor(0x380D, 0);
    write_cmos_sensor(0x380E, 3);
    write_cmos_sensor(0x380F, -32);
    write_cmos_sensor(0x3810, 0);
    write_cmos_sensor(0x3811, 8);
    write_cmos_sensor(0x3812, 0);
    write_cmos_sensor(0x3813, 4);
    write_cmos_sensor(0x3814, 49);
    write_cmos_sensor(0x3815, 49);
    write_cmos_sensor(0x3817, 0);
    write_cmos_sensor(0x3820, 8);
    write_cmos_sensor(0x3821, 7);
    write_cmos_sensor(0x3826, 3);
    write_cmos_sensor(0x3829, 0);
    write_cmos_sensor(0x382B, 11);
    write_cmos_sensor(0x3830, 0);
    write_cmos_sensor(0x3836, 0);
    write_cmos_sensor(0x3837, 0);
    write_cmos_sensor(0x3838, 0);
    write_cmos_sensor(0x3839, 4);
    write_cmos_sensor(0x383A, 0);
    write_cmos_sensor(0x383B, 1);
    write_cmos_sensor(0x3B00, 0);
    write_cmos_sensor(0x3B02, 8);
    write_cmos_sensor(0x3B03, 0);
    write_cmos_sensor(0x3B04, 4);
    write_cmos_sensor(0x3B05, 0);
    write_cmos_sensor(0x3B06, 4);
    write_cmos_sensor(0x3B07, 8);
    write_cmos_sensor(0x3B08, 0);
    write_cmos_sensor(0x3B09, 2);
    write_cmos_sensor(0x3B0A, 4);
    write_cmos_sensor(0x3B0B, 0);
    write_cmos_sensor(0x3B0C, 61);
    write_cmos_sensor(0x3F01, 13);
    write_cmos_sensor(0x3F0F, -11);
    write_cmos_sensor(0x4000, -119);
    write_cmos_sensor(0x4001, 2);
    write_cmos_sensor(0x4002, 69);
    write_cmos_sensor(0x4004, 2);
    write_cmos_sensor(0x4005, 24);
    write_cmos_sensor(0x4006, 8);
    write_cmos_sensor(0x4007, 16);
    write_cmos_sensor(0x4008, 0);
    write_cmos_sensor(0x4300, -8);
    write_cmos_sensor(0x4303, -1);
    write_cmos_sensor(0x4304, 0);
    write_cmos_sensor(0x4307, -1);
    write_cmos_sensor(0x4520, 0);
    write_cmos_sensor(0x4521, 0);
    write_cmos_sensor(0x4511, 34);
    write_cmos_sensor(0x5780, -4);
    write_cmos_sensor(0x5781, 31);
    write_cmos_sensor(0x5782, 3);
    write_cmos_sensor(0x5786, 32);
    write_cmos_sensor(0x5787, 64);
    write_cmos_sensor(0x5788, 8);
    write_cmos_sensor(0x5789, 8);
    write_cmos_sensor(0x578A, 2);
    write_cmos_sensor(0x578B, 1);
    write_cmos_sensor(0x578C, 1);
    write_cmos_sensor(0x578D, 12);
    write_cmos_sensor(0x578E, 2);
    write_cmos_sensor(0x578F, 1);
    write_cmos_sensor(0x5790, 1);
    write_cmos_sensor(0x4800, 36);
    write_cmos_sensor(0x481F, 60);
    write_cmos_sensor(0x4826, 0);
    write_cmos_sensor(0x4837, 24);
    write_cmos_sensor(0x4B00, 6);
    write_cmos_sensor(0x4B01, 10);
    write_cmos_sensor(0x5000, -1);
    write_cmos_sensor(0x5001, 0);
    write_cmos_sensor(0x5002, 65);
    write_cmos_sensor(0x5003, 10);
    write_cmos_sensor(0x5004, 0);
    write_cmos_sensor(0x5043, 0);
    write_cmos_sensor(0x5013, 0);
    write_cmos_sensor(0x501F, 3);
    write_cmos_sensor(0x503D, 0);
    write_cmos_sensor(0x5180, 8);
    write_cmos_sensor(0x5A00, 8);
    write_cmos_sensor(0x5B00, 1);
    write_cmos_sensor(0x5B01, 64);
    write_cmos_sensor(0x5B02, 0);
    write_cmos_sensor(0x5B03, -16);
    write_cmos_sensor(0x4837, 23);
